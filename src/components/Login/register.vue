  ...
  <div id="register_div_right">
    ...
    <div :class="{ on: !is_admin }">
      ...
      <el-input
        ...
        v-on:input="refresh_progress"
      >
        <el-button slot="append" :disabled="show" @click="send_auth_code">
          {{
    ...
    <el-progress
      :percentage="this.progress_value"
      status="success"
      class="register_progress"
    ></el-progress>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    register() {
      ...
      console.log(this.return_auth_code);
      if (
        this.tel.length === 0 ||

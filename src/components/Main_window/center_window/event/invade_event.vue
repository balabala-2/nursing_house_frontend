...
export default {
  data() {
    return {
      ...
      base_face_feature_img_url: "http://127.0.0.1:8000/api/invade_img/",
  ...
  methods: {
    ...
    init() {
      this.$api.get_invade_event().then(response => {
